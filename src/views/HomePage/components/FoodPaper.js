...
export default function SimplePaper(props) {
  ...
  return (
    <div className={styles.content}>
      {props.type === "food" && <Chip icon={<RestaurantIcon style={{ color: "#30374e" }} />} label="" />}
      {props.type === "drink" && (
        <Chip icon={<FreeBreakfastIcon style={{ color: "#30374e"}}/>} label="" />
      )}
      {props.type === "order" && (
        <Chip icon={<Fastfood style={{ color: "#30374e" }}/>} label="Today's Menu" />
      )}
